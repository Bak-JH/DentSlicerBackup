...
void LabellingTextPreview::updateTransform()
{
    ...
    qDebug() <<"width:"<<  this->contentWidth<<" length: "<<length;
    ...
    planeTransform->setTranslation(translation - normal + tangent*callibration -binormal*callibration/this->contentWidth*18.0f);
    //planeTransform->setTranslation(translation + normal * 0.5f + tangent * callibration - binormal *(callibration/2.0f));// (callibration / this->contentWidth * 18.2f));

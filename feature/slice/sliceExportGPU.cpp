...
void Hix::Features::SliceExportGPU::run()
{
	...
	// Export to SVG
	Hix::Slicer::SlicerGL slicer((int)setting.layerHeight/1000.0f, tmpPath, setting.AAXY, setting.AAZ, setting.minHeight);
	...
	//write info files
	Hix::Slicer::InfoWriter iw(tmpPath, printerSetting.sliceImageResolutionX, printerSetting.sliceImageResolutionY, (int)setting.layerHeight/1000.0f);
	iw.createInfoFile();

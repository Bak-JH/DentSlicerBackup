...
std::vector<LLIPoint> getPaddedProj(Mesh *mesh, int floatPointPadding) {
...
std::vector<XYArrangement> autoarrange::arngMeshes(std::vector<Mesh> meshes, std::vector<Qt3DCore::QTransform*> m_transform_set){

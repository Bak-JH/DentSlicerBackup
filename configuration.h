...
public:
    ...
    static constexpr float vertex_inbound_distance = 0.03;//int64_t(std::round(0.03 * resolution));//0.1;//(float)1/resolution; // resolution in mm (0.0001 and 0.0009 are same, 1 micron)
